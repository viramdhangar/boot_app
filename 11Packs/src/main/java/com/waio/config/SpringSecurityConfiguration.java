...
public class SpringSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/payumoney").permitAll()
		...
		.antMatchers("/identity/app/version").permitAll()
		...
		.antMatchers("/api/job/v1/returnCanceledLeagueAmount/*").permitAll()
		...
		.antMatchers("/paytm/generate/checksum").permitAll()
		.antMatchers("/paytm/access/token").permitAll()
