...
public class UserSql {
	...
	public static final String UPDATE_USER_SQL = "update users set password=?, unique_number=?, email=?, firstname=?, lastname=?, middlename=?, referral_code=? where username=?";
	public static final String CREATE_USER_INI_SQL = "insert into users (username, unique_number) values (?,?)";
	...
	public static final String VALIDATE_DUPLICATE_EMAIL_SQL = "select count(username) from users where username = ? OR email=? OR unique_number=?";
